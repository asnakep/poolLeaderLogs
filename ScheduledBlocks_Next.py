...
class SlotLeaderCheck:
    ...
    def checkLeaderSlots(self,verbose):
        ...
        if verbose == True:
            print()
            print(col.bold + f'Checking Next SlotLeader Schedules for Stakepool: ' + (col.green + PoolTicker + col.endcl))
            print()
            print(col.bold + f'Pool Id: ' + (col.green + PoolId + col.endcl))
            print()
            print(col.bold + f'Next Epoch: ' + col.green + str(self.epoch) + col.endcl)
            print()
            print(col.bold + f'New Nonce: ' + col.green + str(self.eta0) + col.endcl)
            print()
